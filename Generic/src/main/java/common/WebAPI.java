...
public class    WebAPI {
    ...
    public static List<String> getTextFromWebElement(String locator, WebDriver driver1) {
        List<WebElement> element = new ArrayList<WebElement>();
        List<String> text = new ArrayList<String>();
        element = driver1.findElements(By.xpath(locator));
        for (WebElement web : element) {
            String st = web.getText();
            text.add(st);
        }
    ...
    //For iframeHandel
    public void handelIframe2(String element){driver.findElements(By.id("iframe"));};
